 ...
 */
public class LancetEditText extends AppCompatEditText {
    private onBackKeyEvent keyEvent;

    public LancetEditText(Context context) {
        super(context);
    }

    public LancetEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LancetEditText(Context context, AttributeSet attrs, int defStyleAttr) {
