...
import cn.jetpack.R;
import cn.jetpack.exoplayer.IPlayTarget;
...
public class ListPlayerView extends FrameLayout implements IPlayTarget, PlayerControlView.VisibilityListener, Player.Listener {
    ...
    public LancetImageView cover, blur;
    ...
    public void bindData(String category, int widthPx, int heightPx, String coverUrl, String videoUrl) {
        ...
        if (widthPx < heightPx) {
            LancetImageView.setBlurImageUrl(blur, coverUrl, 10);
    ...
    public void onActive() {
        ...
        PageListPlay pageListPlay = PageListPlayManager.get(mCategory);
        StyledPlayerView playerView = pageListPlay.playerView;
