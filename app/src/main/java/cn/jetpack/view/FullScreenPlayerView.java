...
import cn.jetpack.R;
import cn.jetpack.exoplayer.PageListPlay;
import cn.jetpack.exoplayer.PageListPlayManager;
...
public class FullScreenPlayerView extends ListPlayerView {
    ...
    public FullScreenPlayerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        exoPlayerView = (StyledPlayerView) LayoutInflater.from(context).inflate(R.layout.layout_exo_player_view, null, false);
    }
    ...
    public void onActive() {
        ...
        StyledPlayerView playerView = exoPlayerView;//pageListPlay.playerView;
